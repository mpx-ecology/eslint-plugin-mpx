...
module.exports = {
  ...
  rules: {
    ...
    'no-call-expressions-in-template': require('./rules/no-call-expressions-in-template')
  },
  configs: {
    ...
    'flat/mpx-essential': require('./configs/flat/mpx-essential'),
    'flat/composition-api-essential': require('./configs/flat/composition-api-essential')
  },
  processors: {
